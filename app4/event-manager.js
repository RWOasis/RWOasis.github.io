...
AFRAME.registerComponent('event-manager', {
  ...
  onClick: function (evt) {
    ...
    if (targetEl === this.boxButtonEl ||
      ...
      this.boxGeometryEl.object3D.position.set(0, 0, -50);
      this.sphereGeometryEl.object3D.position.set(0, 0, -50);
      this.torusGeometryEl.object3D.position.set(0, 0, -50);
      this.buttonToGeometry[targetEl.id].object3D.position.set(0, 0.1, -3);
    }
